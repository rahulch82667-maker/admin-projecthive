        ...
        <div className="max-w-6xl mx-auto space-y-8 pb-20">
          ...
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-10 bg-stone-50/80 backdrop-blur-md py-4 border-b border-stone-100 -mx-4 px-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-stone-900 uppercase tracking-tight">Create Project</h2>
                <p className="text-stone-500 text-xs font-bold uppercase tracking-wider">Fill all details to publish your asset</p>
              </div>
            </div>
